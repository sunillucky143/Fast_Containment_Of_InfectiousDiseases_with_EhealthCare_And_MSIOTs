...
<head>
<title>E_View_Vaccinated_Mobile_Users_Selection</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style2">View All Vaccinated Users</span></h2>
          <p>&nbsp;</p>
          <form id="form1" name="form1" method="post" action="A_View_Vaccinated_Mobile_Users_Selection.jsp">
            <span class="style11">Select Vaccination Status</span> 
            <select name="vstatus">
	...
	<td  width="82" height="34" valign="baseline" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="center" class="style15 style21 style6 style9 style7 style7">Vaccination Status</div></td>
          </tr>
           
            <%
					 
						String s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,s12,s66;
						int i=1;
						try 
						{
							...
							int count=0;
						   	...
						   	String query="select * from Infectious_Diseases where vstatus='"+vstatus+"' "; 
							  ...
							  count++;
								...
								String keys = "ef50a0ef2c3e3a5f";
									   ...
									   String s177= new String(Base64.decode(s66.getBytes()));
            ...
            <tr>
			  ...
			  <td  valign="baseline" height="0"><p class="style22 style7">&nbsp;</p>
				  ...
				  <td height="0"  valign="baseline" bgcolor="#FFFF00"><p class="style22 style7 style7">&nbsp;</p>
                  <div align="center" class="style22 style7 style7">
