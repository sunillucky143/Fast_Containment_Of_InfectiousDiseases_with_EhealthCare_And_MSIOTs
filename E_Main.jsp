...
<head>
<title>Social Server Main Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style2">Wel-Come Social Server </span></h2> 
          <p class="infopost">&nbsp;</p>
      ...
      <div class="sidebar">
        <div class="gadget">
          <h2 class="star"><span>Social Server </span></h2>
          <div class="clr"></div>
          <ul class="sb_menu style3">
		    <li><strong><a href="E_Main.jsp">Home</a></strong></li>
			<li><strong><a href="E_View_All_Disease.jsp">View All Diseases</a></strong></li>
			<li><strong><a href="E_Search_Patients.jsp">Search Patients</a></strong></li>
