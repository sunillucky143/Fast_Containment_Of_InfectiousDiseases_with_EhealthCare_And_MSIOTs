...
<head>
<title>A_View_Fast_Containment_Zones</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style2">View Fast Containment Zones</span></h2>
          <p>&nbsp;</p>
	...
	<td  width="82" height="34" valign="baseline" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="center" class="style15 style21 style6 style9 style7">Zone</div></td>
          </tr>
    ...
    <td  valign="baseline" height="0"><p class="style22 style7">&nbsp;</p>
            ...
            <%
					...
					if(count<=0)
						{%>
						<h2>NO CONTAINMENT ZONE FOUND</h2>
