...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <form id="form1" name="form1" method="post" action="E_Search_Patients.jsp">
            <p>&nbsp;</p>
            <p><span class="style2 style8">Enter  Location Name </span>
              <input name="kword" type="text" size="30" placeholder="Enter Location Name">
              <input type="submit" name="Submit" value="Submit" />
            </p>
            <p>&nbsp;</p>
          </form>
          <p><span class="style2 style8">View All Patient Details  </span></p>
            ...
            <%
						...
						try 
						{
							...
							int count=0;
						   	...
						   	String query="select * from Infectious_Diseases where rtype='"+stype+"' and loc='"+kword+"' "; 
