...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style2">Wel-Come Mobile User :: <%=(String)application.getAttribute("uname")%></span></h2>
          <p><img src="images/UserMain.jpg" width="600" height="338" /></p>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="clr"></div>
        </div>
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu style3">
		    <li><strong><a href="U_Profile.jsp">My Profile</a></strong></li>
	 		<li><strong><a href="U_AddInfectious_Diseases.jsp">Add Infectious Diseases</a></strong></li>
			<li><strong><a href="U_View_My_Disease.jsp">View My Disease</a></strong></li>
